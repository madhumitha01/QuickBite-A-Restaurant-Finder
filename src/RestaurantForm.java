...
//		JLabel lblQuantity = new JLabel("Rating:");
		...
		btnAddRestaurant.addActionListener(new ActionListener() {
			...
			String category=textField_3.getText();
				...
				if (name == null || name.trim().equals("") || address == null || address.trim().equals("") || category ==null || category.trim().equals("")) {
					JOptionPane.showMessageDialog(RestaurantForm.this, "Please fill in all the details",
